"""Generated wrapper for PermissionedBridge Solidity contract."""
...
# constructor for PermissionedBridge below.
try:
    # both mypy and pylint complain about what we're doing here, but this
    # works just fine, so their messages have been disabled here.
    from . import (  # type: ignore # pylint: disable=import-self
        PermissionedBridgeValidator,
    )
except ImportError:

    class PermissionedBridgeValidator(Validator):  # type: ignore
...
class OperatorWeightsMethod(ContractMethod):  # pylint: disable=invalid-name
    """Various interfaces to the operatorWeights method."""
    ...
    def validate_and_normalize_inputs(self, index_0: str):
        """Validate the inputs to the operatorWeights method."""
        self.validator.assert_valid(
            method_name="operatorWeights",
            parameter_name="index_0",
            argument_value=index_0,
        )
        index_0 = self.validate_and_checksum_address(index_0)
...
class SetOperatorWeightMethod(ContractMethod):  # pylint: disable=invalid-name
    """Various interfaces to the setOperatorWeight method."""
    ...
    def validate_and_normalize_inputs(self, operator: str, weight: int):
        """Validate the inputs to the setOperatorWeight method."""
        self.validator.assert_valid(
            method_name="setOperatorWeight",
            parameter_name="operator",
            argument_value=operator,
        )
        operator = self.validate_and_checksum_address(operator)
    ...
    def call(
        self, operator: str, weight: int, tx_params: Optional[TxParams] = None
    ) -> None:
        """Execute underlying contract method via eth_call.
        ...
        :returns: the return value of the underlying method.
        """
        (operator, weight) = self.validate_and_normalize_inputs(
            operator, weight
        )
        tx_params = super().normalize_tx_params(tx_params)
        self._underlying_method(operator, weight).call(tx_params.as_dict())
    ...
    def send_transaction(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(operator, weight).transact(
            tx_params.as_dict()
        )
    ...
    def build_transaction(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(operator, weight).buildTransaction(
            tx_params.as_dict()
        )
    ...
    def estimate_gas(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(operator, weight).estimateGas(
            tx_params.as_dict()
        )
...
class PermissionedBridge:
    """Wrapper class for PermissionedBridge Solidity contract.
    ...
    operator_weights: OperatorWeightsMethod
    """Constructor-initialized instance of
    :class:`OperatorWeightsMethod`.
    """
    ...
    set_operator_weight: SetOperatorWeightMethod
    """Constructor-initialized instance of
    :class:`SetOperatorWeightMethod`.
    """
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: PermissionedBridgeValidator = None,
    ):
        ...
        if not validator:
            validator = PermissionedBridgeValidator(
        ...
        self.operator_weights = OperatorWeightsMethod(
            web3_or_provider,
            contract_address,
            functions.operatorWeights,
            validator,
        )
        ...
        self.set_operator_weight = SetOperatorWeightMethod(
            web3_or_provider,
            contract_address,
            functions.setOperatorWeight,
            validator,
        )
